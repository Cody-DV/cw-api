...
def aggregate_data():
    ...
    for transaction in transactions:
        ...
        if item_name:
            ...
            aggregated_data[item_name]["total_quantity"] += transaction.get("quantity", 1)
            ...
            if recipe_data:
                ...
                aggregated_data[item_name]["total_calories"] += nutrients.get("calories", {}).get("value", 0)
                aggregated_data[item_name]["total_fat"] += nutrients.get("fat", {}).get("value", 0)
                aggregated_data[item_name]["total_protein"] += nutrients.get("protein", {}).get("value", 0)
